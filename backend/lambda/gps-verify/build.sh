...
# gps-verify Lambda関数のZIPファイル作成スクリプト
...
# 出力ファイル名
ZIP_FILE="lambda-gps-verify.zip"
...
echo "3. 環境変数を設定（TABLE_STAMPMASTERS）"
echo "4. IAMロールにDynamoDB読み取り権限を追加"
echo "5. API Gatewayでエンドポイントを設定（POST /gps/verify または /gps/check）"
echo ""
