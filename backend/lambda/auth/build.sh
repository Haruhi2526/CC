...
echo "3. 環境変数を設定（TABLE_USERS, TOKEN_SECRET_KEY）"
echo "4. IAMロールにDynamoDB権限を追加"
echo ""
echo "詳細は docs/AWS-Console実装手順-auth関数.md を参照してください。"
