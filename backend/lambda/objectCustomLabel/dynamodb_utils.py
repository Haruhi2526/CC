...
def find_stamp_by_image_label(image_label: str) -> Optional[Dict[str, Any]]:
    """
    ImageLabelでスタンプマスターを検索
    
    Args:
        image_label (str): 画像認識ラベル
    ...
    try:
        ...
        raise Exception(f"Failed to find stamp by image label: {str(e)}")
