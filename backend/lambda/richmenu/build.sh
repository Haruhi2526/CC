...
# richmenu Lambda関数のZIPファイル作成スクリプト
...
echo "3. 環境変数を設定（LINE_CHANNEL_ACCESS_TOKEN）"
echo "4. IAMロールに追加の権限は不要（LINE API呼び出しのみ）"
echo "5. API Gatewayでエンドポイントを設定:"
echo "   - GET /richmenu/list"
echo "   - POST /richmenu/set"
echo "   - DELETE /richmenu/unset"
echo "   - GET /richmenu/default"
echo "6. CORS設定を確認"
echo ""
